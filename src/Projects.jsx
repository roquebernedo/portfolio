...
const firstTool = ['Javascript', 'React', 'CSS', 'Redux', 'Node/Express', 'MondoDB', 'Stripe']
  ...
  return (
    <div className='main-projects' id='projects'>
        ...
        <Project
            ...
            introduction={"An eCommerce site attempting to fill the world's insatiable need for all things, clothing and much more. We closely followed and emulated the top online shopping experiences to deliver a fun, original website."}
            render={'Note: This App will be hosted on Netlify and Render server. Try to choose what suits you best and put it in the shopping cart'}
            webDirection={'https://ecommerce-rq.netlify.app/'}
            gitDirection={'https://github.com/roquebernedo/E-commerce'}
            titleImg={'ecommerce'}
            imgDirection={require('./images/dirsleystore.JPG')}
        />
